...
SELECT 
    ...
    CONCAT(N'Driver', d.driver_id) AS [Source image name],
    t.team_id AS TargetId,
    t.name AS TargetName,
    CONCAT(N'Team', t.team_id) AS [Target image name],
    m.season_start,
    m.season_end,
    m.role,
...
SELECT 
    ...
    CONCAT(N'Car', c.car_id) AS [Target image name],
    dr.year_from,
    dr.year_to,
    dr.wins_on_this_car,
...
SELECT 
    ...
    CONCAT(N'Track', tr.track_id) AS [Target image name],
    w.win_date,
    w.position,
    w.race_name,
...
SELECT 
    ...
    CONCAT(N'Team', t.team_id) AS [Source image name],
    c.car_id AS TargetId,
    c.model AS TargetName,
    CONCAT(N'Car', c.car_id) AS [Target image name],
    u.season,
